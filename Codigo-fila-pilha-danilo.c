...
bool Menu(){
    ...
    continuar = EscolherNomeDessaFuncaoDepois(escolha);
    ...
    switch(escolha){
        case '1':
            ...
            if(escolha_fila == 1){
                ...
                result = Fila_create(&fila_normal, sizeof(int), TAM, false);
                if(result == true){
                ...
                result = Fila_create(&fila_preferencial, sizeof(int), TAM, true);
                if(result == true){
                    printf("\nFila criada com sucesso!\n");
